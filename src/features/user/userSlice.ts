...
export const selectIsUserSignedIn = (state: RootState) => state.user.signedIn;
export const selectIsUserLoading = (state: RootState) => state.user.signedIn === SignInStatus.LOADING;
